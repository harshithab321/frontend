       ...
       <div  onClick={() => handleItemClick(user._id)}>
          ...
          <div key={user._id}>
            <Card style={{ width: "400px", marginTop: '0px', marginLeft: '0px',height: '200px', marginRight: '20px', border: 'none' }}>
              <Card.Img variant="top" style={{ width: '200px', height: '50px' ,marginTop:"20px"}} src={user.images[0]} />
              <Card.Body>
                <div>
                  {[...Array(5)].map((_, i) => {
                    const starValue = i + 1;
            ...
            {index + 1 < users.length && (
              <Card style={{ width: '400px', marginTop: '20px', marginLeft: '40px', height: '200px',marginRight: '20px', border: 'none' }}>
                <Card.Img variant="top" style={{ width: '200px', height: '50px',marginTop:"20px" }} src={users[index + 1].images[0]} />
                <Card.Body>
