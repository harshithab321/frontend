...
<div  style={{background:"lightgray",width:"100%",height:"800px",marginTop:"300px",position:"relative" }}>
    ...
    <Navbar bg="primary" data-bs-theme="dark" style={{marginTop:"100px",width:"1200px", position:'absolute',marginLeft:"30px" ,padding:"20px"}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <ul>
          <li><Link  style={{ textDecoration: "none", color: "black" }}  to="/Hydraulic">Hydraulic</Link></li>
          <li><Link   style={{ textDecoration: "none", color: "black" }} to="/Lamp">Lamp</Link></li>
          <li><Link   style={{ textDecoration: "none", color: "black" }} to="/Checout">Checout</Link></li>
          <li><Link  style={{ textDecoration: "none", color: "black" }}  to="/induction">induction</Link></li>
          <li><Link  style={{ textDecoration: "none", color: "black" }}  to="/Avionics">Avionics</Link> </li>
    ...
    <div  style={{listStyleType:"none"}}>
      ...
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Avionics">Avionics</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link    style={{ textDecoration: "none", color: "black" }} to="/Lamp">Lamp</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Avionics">Avionics</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Electronics">Electronics</Link> </div>
      <div style={{ paddingRight: "10px", marginBottom: "10px" }}>Handwatch</div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Circuits">Circuits</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Cryotronics">Cryotronics</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Hydraulic">Hydraulic</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Accessories">Accessories</Link> </div>
      ...
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Hydraulic">Hydraulic</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Accessories">Accessories</Link> </div>
    <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link  style={{ textDecoration: "none", color: "black" }}  to="/Avionics">Hydraulic</Link> </div>
      <div style={{ borderRight: "1px solid gray", paddingRight: "10px", marginBottom: "10px" }}><Link   style={{ textDecoration: "none", color: "black" }} to="/Avionics">Accessories</Link> </div>
