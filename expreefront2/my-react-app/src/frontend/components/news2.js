...
<div className='d-flex flex-wrap ml-4 mt-4'>
    ...
    <div   style={{marginLeft:"-50px"}} className='d-flex align-items-center mt-3'>
      <div className="d-flex align-items-center me-3">
        <i className="bi bi-calendar"></i>
        <p className="ms-2 mb-0">Calender</p>
        <div className="ms-2">May 2023</div>
      </div>

      <div className="d-flex align-items-center me-3">
        <i className="bi bi-pencil"></i>
        <p className="ms-2 mb-0">Admin</p>
        <div className="ms-2">Username</div>
      </div>

      <div  onClick={handelstate} className="d-flex align-items-center">
        <i className="bi bi-list"></i>
        <p className="ms-2 mb-0">List</p>
      </div>
    </div>
   
      <img style={{margin:"80px  -200px",zIndex:"1", width: '800px', height: '500px' }}
                      src="https://images.unsplash.com/photo-1553729784-e91953dec042?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8cmVhZGluZ3xlbnwwfHwwfHx8MA%3D%3D"
                      className="card-img-top"
                      alt="..."
                    />
